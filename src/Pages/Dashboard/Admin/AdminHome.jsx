                    ...
                    <tbody>
                        {
                            allUsers?.map((user, index) =>
                                <tr key={user._id}>
                                    ...
                                    <td>{user.email} </td>
                                    <th> {user.role === 'admin' ? 'Admin' : <button onClick={() => handleAdminRole(user)} className="btn border-none btn-outline bg-[#D1A054]"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    ...
                                    <th>
                                        <button onClick={() => handleDelete(user._id)} className="btn border-none btn-outline bg-[#B91C1C]"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
